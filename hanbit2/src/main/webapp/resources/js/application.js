...
var account = (function(){
	...
	var onCreate = function(){
    	...
    	$('#account_mgmt #count').click(function(){controller.move('account','find');});
	};
	return {
		...
		spec : function(){
			 ...
			 * setMoney(0); document.querySelector('#result_account').innerHTML =
			 * getAccountNo();
			 */
		},
		deposit : function (){
...
var member = (function(){
	...
	return {
		...
		spec : function (){
			 ...
			 * setSSN(document.querySelector('#ssn').value); console.log('GET
			 * SSN'+getSSN()); setName(document.querySelector('#name').value);
			 * var now = new Date().getFullYear(); var ssnArr =
			 * getSSN().split("-"); var ageResult1 = ssnArr[0]; var genderResult =
			 * Number(ssnArr[1]); var ageResult0 = 0; switch (genderResult) {
			 * case 1: case 5: setGender("남"); ageResult0 = now -
			 * 1900-(ageResult1/10000);
			 * setAge(ageResult0.toString().split(".")[0]); break; case 3: case
			 * 7: setGender("남"); ageResult0 = now - 2000-(ageResult1/10000);
			 * setAge(ageResult0.toString().split(".")[0]); break; case 2: case
			 * 6: setGender("여"); ageResult0 = now - 1900-(ageResult1/10000);
			 * setAge(ageResult0.toString().split(".")[0]); break; case 4: case
			 * 8: setGender("여"); ageResult0 = now - 2000-(ageResult1/10000);
			 * setAge(ageResult0.toString().split(".")[0]); break; }
...
var grade = (function(){
	...
	var setContentView = function(){
		...
		$('#grade_regist').addClass('box').css('padding','');
		...
		$('#grade_update').addClass('box').css('padding','');
	...
	var onCreate = function(){
    	...
    	$('#g_update').click(function(){alert('수정하시려면 회원리스트로 이동해 주세요');controller.move('grade','list');});
	};
	return {
		init : init,
	};
...
var admin = (function() {
    ...
    var setContentView = function(){
    	...
    	$('#admin_content #img_1').attr('src',app.img()+'/footer.png');
    	$('#admin_content #img_2').attr('src',app.img()+'/header.png');
    	$('#admin_content #img_3').attr('src',app.img()+'/loader.png');
    	$('nav').css('height','50px');
